...
const main = require("./main-C7JIsRYW.js");
...
var globalThis_1 = (
  ...
  check(typeof self == "object" && self) || check(typeof main.commonjsGlobal == "object" && main.commonjsGlobal) || check(typeof main.commonjsGlobal == "object" && main.commonjsGlobal) || // eslint-disable-next-line no-new-func -- fallback
  /* @__PURE__ */ function() {
    return this;
...
const _asyncToGenerator = /* @__PURE__ */ main.getDefaultExportFromCjs(asyncToGeneratorExports);
...
(function(module2) {
  var _typeof2 = main._typeofExports["default"];
...
const _defineProperty = /* @__PURE__ */ main.getDefaultExportFromCjs(definePropertyExports);
...
var now = performanceNowExports, root = typeof window === "undefined" ? main.commonjsGlobal : window, vendors = ["moz", "webkit"], suffix = "AnimationFrame", raf = root["request" + suffix], caf = root["cancel" + suffix] || root["cancelRequest" + suffix];
...
const requestAnimationFrame = /* @__PURE__ */ main.getDefaultExportFromCjs(rafExports);
var whitespaces$2 = "	\n\v\f\r                　\u2028\u2029\uFEFF";
...
const RGBColor$1 = /* @__PURE__ */ main.getDefaultExportFromCjs(rgbcolor);
var $$2 = _export;
